 ...
 *
 **/
inline RC_t RTE_SC_CLOCK_init( SC_CLOCK_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_CLOCK_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_CLOCK_t * const signal: Pointer to the signal object
 * @return sc_clock_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_CLOCK_data_t* RTE_SC_CLOCK_getPtr( SC_CLOCK_t * const signal )
{               
