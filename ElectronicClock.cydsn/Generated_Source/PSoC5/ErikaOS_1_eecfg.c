 ...
 **************************************************************************/
    ...
    #define TASK_1_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_1[TASK_1_STACK_SIZE];	/* Task 1 (tsk_background) */
    #endif
    ...
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_hmi) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        {0}
        #ifdef TASK_1_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_1[(TASK_1_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_background*/
        #endif
        #ifdef TASK_2_STACK_SIZE
        ...
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_hmi*/
        #endif
        #ifdef TASK_7_STACK_SIZE
