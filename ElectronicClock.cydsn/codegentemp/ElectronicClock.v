...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_2583),
        .rx_data(Net_2584),
        .rx_interrupt(Net_2585),
        .tx(Net_2586),
        .tx_clk(Net_2587),
        .tx_data(Net_2588),
        .tx_en(Net_2589),
        .tx_interrupt(Net_2590));
    ...
    assign Net_2626 = Net_260 | Net_261 | Net_263 | Net_264;
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_2730),
        .sclk(wTFT_SCL),
        .sdat(Net_2731),
        .ss(Net_2732),
        .tx_interrupt(Net_2733));
