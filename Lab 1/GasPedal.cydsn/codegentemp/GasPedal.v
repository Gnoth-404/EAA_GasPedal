...
module ADC_SAR_SEQ_v2_10_5 (
	...
	cy_clock_v1_0
		#(.id("8eb5d437-e29a-462f-9061-ceecc5a599dd/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("8eb5d437-e29a-462f-9061-ceecc5a599dd/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_2199),
        .rx_data(Net_2200),
        .rx_interrupt(Net_2201),
        .tx(Net_2202),
        .tx_clk(Net_2203),
        .tx_data(Net_2204),
        .tx_en(Net_2205),
        .tx_interrupt(Net_2206));
	...
	cy_psoc3_pins_v1_10
		#(.id("88a16469-a32a-40bb-94ef-95a37ddadfff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d7a8b12f-1d92-4506-bea6-183af5cf4cd5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("b33377ee-afde-40f1-8e0a-13aa72f48b23"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b8b3d6a5-edaa-4510-80a5-54f01363be28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c0ab2431-882e-4e27-8bdb-3be6069cee65"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("412331bb-abde-4c9e-ab4d-59e88391b7f3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d4cc4ff5-f80b-48de-9365-3258543ba486"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f86fa044-b5a3-4352-b693-67ad8e9a15ad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bc5df63c-f944-4b29-8f61-a1aefda3e9f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("810cb75b-01df-4d15-983a-349c40d0793e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2a1ed980-0585-4041-8e6a-e7fc5d0e3475"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4c99f9ad-295e-463c-ab47-fe68e3727c4d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8c08a741-f7e6-4f73-85b4-04ef42486882"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e35d92b8-d8ca-4df6-ab8c-c32616b8babc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("26fd2568-a5dd-40c8-a466-adccc908da11"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2e2fc967-676d-44c7-9af9-91431810c2f6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8fafdd0f-022c-4d0c-9052-624c5b610b9d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("126c64bf-dff6-4eed-bd9f-ca6b0e1e3f2f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_2242 = Net_260 | Net_261 | Net_263 | Net_264;
	...
	cy_psoc3_pins_v1_10
		#(.id("d2b713b0-f437-4958-9849-42793d15d9db"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d9018990-3ca9-4654-a0db-7bda5113aca2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f03ee580-cf4a-4777-9daf-b00fa6f79b63"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_2438),
        .sclk(wTFT_SCL),
        .sdat(Net_2439),
        .ss(Net_2440),
        .tx_interrupt(Net_2441));
