...
/**
 *  file    SC_SCREEN_signal.h
 *
 *  brief   signal base class for signal sc_screen
 *
...
#ifndef SC_SCREEN_SIGNAL_H_INCLUDED
#define SC_SCREEN_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_SCREEN_driverIn_t)(SC_SCREEN_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_SCREEN_driverOut_t)( const SC_SCREEN_data_t * const);
...
/**
 * Instances of the struct SC_SCREEN_cfg_t represent the signal object configuration.
 */
struct SC_SCREEN_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_SCREEN_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_SCREEN_driverOut_t const outDriver;
...
typedef const struct SC_SCREEN_cfg_s SC_SCREEN_cfg_t;
...
/**
 * Instances of the struct SC_SCREEN_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const SC_SCREEN_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_SCREEN_s SC_SCREEN_t;
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_SCREEN_init( SC_SCREEN_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_SCREEN_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_SCREEN_getStatus( const SC_SCREEN_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_SCREEN_setStatus( SC_SCREEN_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_SCREEN_getAge( const SC_SCREEN_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_SCREEN_incAge(  SC_SCREEN_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object
 * @return sc_screen_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_SCREEN_data_t* RTE_SC_SCREEN_getPtr( SC_SCREEN_t * const signal )
{               
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object
 * @return sc_screen_data_t: current value of the application data buffer
 *
 **/
inline SC_SCREEN_data_t RTE_SC_SCREEN_get( const SC_SCREEN_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object
 * @param  SC_SCREEN_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_SCREEN_getThreadSafe( const SC_SCREEN_t * const signal, SC_SCREEN_data_t * const data )
{    
 ...
 *
 * @param  SC_SCREEN_t * const signal: Pointer to the signal object
 * @param  sc_screen_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_SCREEN_set(SC_SCREEN_t * const signal, const SC_SCREEN_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_SCREEN_pullPort( SC_SCREEN_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_SCREEN_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_SCREEN_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_SCREEN_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_SCREEN_pushPort( const SC_SCREEN_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
