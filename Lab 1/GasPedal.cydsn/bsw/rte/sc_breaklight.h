...
/**
 *  file    SC_BREAKLIGHT_signal.h
 *
 *  brief   signal base class for signal sc_breaklight
 *
...
#ifndef SC_BREAKLIGHT_SIGNAL_H_INCLUDED
#define SC_BREAKLIGHT_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_BREAKLIGHT_driverIn_t)(SC_BREAKLIGHT_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_BREAKLIGHT_driverOut_t)( const SC_BREAKLIGHT_data_t * const);
...
/**
 * Instances of the struct SC_BREAKLIGHT_cfg_t represent the signal object configuration.
 */
struct SC_BREAKLIGHT_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_BREAKLIGHT_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_BREAKLIGHT_driverOut_t const outDriver;
...
typedef const struct SC_BREAKLIGHT_cfg_s SC_BREAKLIGHT_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SC_BREAKLIGHT_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_BREAKLIGHT_s SC_BREAKLIGHT_t;
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BREAKLIGHT_init( SC_BREAKLIGHT_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_BREAKLIGHT_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_BREAKLIGHT_getStatus( const SC_BREAKLIGHT_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_BREAKLIGHT_setStatus( SC_BREAKLIGHT_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_BREAKLIGHT_getAge( const SC_BREAKLIGHT_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_BREAKLIGHT_incAge(  SC_BREAKLIGHT_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object
 * @return sc_breaklight_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_BREAKLIGHT_data_t* RTE_SC_BREAKLIGHT_getPtr( SC_BREAKLIGHT_t * const signal )
{               
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object
 * @return sc_breaklight_data_t: current value of the application data buffer
 *
 **/
inline SC_BREAKLIGHT_data_t RTE_SC_BREAKLIGHT_get( const SC_BREAKLIGHT_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object
 * @param  SC_BREAKLIGHT_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BREAKLIGHT_getThreadSafe( const SC_BREAKLIGHT_t * const signal, SC_BREAKLIGHT_data_t * const data )
{    
 ...
 *
 * @param  SC_BREAKLIGHT_t * const signal: Pointer to the signal object
 * @param  sc_breaklight_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BREAKLIGHT_set(SC_BREAKLIGHT_t * const signal, const SC_BREAKLIGHT_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_BREAKLIGHT_pullPort( SC_BREAKLIGHT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_BREAKLIGHT_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_BREAKLIGHT_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_BREAKLIGHT_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_BREAKLIGHT_pushPort( const SC_BREAKLIGHT_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
